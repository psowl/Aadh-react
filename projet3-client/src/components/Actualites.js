...
function Actualites(props) {
  return (
    <div className="actualitesPage">
      <div className="actuContainerGlobal">
        <ul className="actuContainer">
          <li className="actuCard">
            ...
            <img
              ...
              alt="actuImg"
            ></img>
            <h3> Semaine du Pro Bono France 2020</h3>
            <p>
              Dans le cadre de la European Pro Bono Week, nous avons le plaisir
              de vous inviter à une semaine virtuelle dédiée au Pro Bono en
              France qui réunira les acteurs français du monde...
            </p>
            <Link to={`/actualites`}>
              <h3>Lire la suite...</h3>
            </Link>
          ...
          <li className="actuCard">
            ...
            <p>
              En cette période de crise sanitaire, l’Alliance des Avocats pour
              les Droits de l’Homme est solidaire envers toutes les associations
