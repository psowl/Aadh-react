      ...
      <div className="home">
        ...
        <div className="home_top">
          <section className="actions">
            ...
            <div className="actionsParagraph">
              ...
              <p>
                Fondée en 2009, l’A.A.D.H coordonne un soutien juridique neutre,
                gratuit et confidentiel auprès des organismes, associations et
                institutions dédiés à la protection des droits humains et de
                l’environnement. plus de 26’000 avocats bénévoles mettent leurs
                compétences à la disposition de l’aadh sous la forme de
                consultations écrites, en réponse à l’ensemble des
                problématiques juridiques rencontrées par ces organisations.
              </p>
              <p>
                L’A.A.D.H est sollicitée par les organisations dans 4 situations
                majeures :
              </p>
            </div>
                  ...
                  <div>
                    ...
                    {this.state.retweets[i] ? (
                      <img
                        ...
                        src={
                          this.state.retweets[i].user.profile_image_url_https
                        }
        ...
        <div className="partenariat">
          ...
          <div className="logos_partenaires">
            ...
            />
            <img
              src="https://images.slideplayer.fr/41/11169180/slides/slide_1.jpg"
              alt=""
            />
            <img
            ...
            />
            <img
              src="https://logonews.fr/wp-content/uploads/2018/01/HI-APRES.png"
              alt=""
            />
            <img
