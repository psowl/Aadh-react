...
const MissionCard = (props) => {
   ...
   return (
      <div className='missionCardSingle'>
         {/* <img src={this.props.profilePic} alt="profilePicMissionCard" /> */}
         <div className='missionCardImage'>
            <img
               src={
                  'https://png.pngtree.com/png-clipart/20190604/original/pngtree-business-profilePic-design-png-image_915991.jpg'
               }
               alt='profilePicMissionCard'
            />
         </div>
         <div>
            <p>{status}</p>
