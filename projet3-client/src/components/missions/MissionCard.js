...
const MissionCard = (props) => {
   ...
   return (
      <div className='missionCardSingle' style={changeBackgroundImage(expertise_required)}>
         ...
         <div className='missionCardSingleContent'>
            <div>
               <div style={styleTextStatus(status)}>
                  <GrStatusGoodSmall className='status' size={10} color={styleIconStatus(status)} />
                  {status}
               </div>
               <img src={requester_id.profilePic} alt='profilePic' />
